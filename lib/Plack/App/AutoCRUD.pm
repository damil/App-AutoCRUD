...
1; # End of Plack::App::AutoCRUD

__END__

=head1 NAME

Plack::App::AutoCRUD - A Plack application for browsing and editing databases
...
in L<Plack::App::AutoCRUD::ConfigDomain>.
...
L<Plack::App::AutoCRUD::ConfigDomain>.
...
L<Plack::App::AutoCRUD::DataSource> class.
...
=head2 new
  ...
  my $crud_app = Plack::App::AutoCRUD->new(%options);
